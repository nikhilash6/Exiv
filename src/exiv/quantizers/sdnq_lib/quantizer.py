...
from ..base import SDNQQuantizerConfig
...
def get_quant_args_from_config(quantization_config: Union["SDNQQuantizerConfig", dict]) -> dict:
    if isinstance(quantization_config, SDNQQuantizerConfig):
...
def sdnq_post_load_quant(
    ...
    quantization_config = SDNQQuantizerConfig(
        weights_dtype=weights_dtype,
        group_size=group_size,
        svd_rank=svd_rank,
        svd_steps=svd_steps,
